...
Here an example where we use a pool of 70 donors ([donors](../reference/donors.html) data frame available from the package) to select from a wait list of 500 transplant [candidates](../reference/candidates.html) (data frame is also available from the package)
